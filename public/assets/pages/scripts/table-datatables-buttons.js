var TableDatatablesButtons = function () {
    ...
    var initTable4 = function () {
        ...
        var oTable = table.dataTable({
            ...
            // Or you can use remote translation file
            //"language": {
            //   url: '//cdn.datatables.net/plug-ins/4cfcc449e89/i18n/Portuguese.json'
            //},
    ...
    var initTable5 = function () {
        ...
        var oTable = table.dataTable({
            ...
            // Or you can use remote translation file
            //"language": {
            //   url: '//cdn.datatables.net/plug-ins/5cfcc559e89/i18n/Portuguese.json'
            //},
    ...
    var initTable6 = function () {
        ...
        // handle datatable custom tools
        $('#tool-action-6-1').on('click', function() {
            var action = $(this).attr('data-action');
            oTable.DataTable().button(action).trigger();
        });
        $('#tool-action-6-2').on('click', function() {
            var action = $(this).attr('data-action');
            oTable.DataTable().button(action).trigger();
        });
        $('#tool-action-6-3').on('click', function() {
            var action = $(this).attr('data-action');
            oTable.DataTable().button(action).trigger();
        });
    }
